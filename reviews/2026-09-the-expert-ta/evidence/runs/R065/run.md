...
|-------|---------|--------------|
| NV1 — Page/view title identifies its purpose | pass | O3 — document.title = "Academic Integrity Templates" (non-empty, specific; the reviewer's NVDA+T confirms wording on the walk) |
...
**view_probe 2026-09-11:** answered NV11=n/a, NV1=pass, NV9=pass by measurement; facts in `R065-probe.json`.
...
- O3 [measured] (state: view as loaded, 2026-09-11 view_probe): document.title = "Academic Integrity Templates" (non-empty, specific; the reviewer's NVDA+T confirms wording on the walk)
...
- (screenshots/exports named R065-<what>.png)
