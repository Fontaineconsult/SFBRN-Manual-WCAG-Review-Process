...
- O3 [measured] (state: view as loaded, 2026-09-11 view_probe): document.title = "Manage Class Roster" (non-empty, specific; the reviewer's NVDA+T confirms wording on the walk)
...
- (screenshots/exports named R053-<what>.png)
