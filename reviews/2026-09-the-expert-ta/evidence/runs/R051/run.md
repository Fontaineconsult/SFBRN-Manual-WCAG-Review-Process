...
| MO9 — Targets are ≥ 24×24 CSS px or adequately spaced | pass | O2 — 13 visible targets measured; 11 under 24×24 px, all spacing-exempt (no other target within a 24 px circle) or inline/user-agent-sized |
...
**view_probe 2026-09-11:** answered MO9=pass, MO10=n/a by measurement; facts in `R051-probe.json`.
...
- O2 [measured] (state: view as loaded, 2026-09-11 view_probe): 13 visible targets measured; 11 under 24×24 px, all spacing-exempt (no other target within a 24 px circle) or inline/user-agent-sized
