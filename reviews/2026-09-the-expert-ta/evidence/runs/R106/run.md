...
| **Result** | Not set — NC1, NC3 need the reviewer — judge from `R106-grayscale.png` (achromatopsia emulation) or the OS filter |
...
**view_probe 2026-09-11:** answered NC2=pass by measurement; facts in `R106-probe.json`.
...
- (screenshots/exports named R106-<what>.png)
