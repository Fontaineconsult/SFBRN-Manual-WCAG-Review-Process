...
| **Evidence** | R109 O5 (S3), R110 O5 (S8), R102 O3 (S6), R099 O4 (S1) — all reviewer, grayscale filter, 2026-09-21; R119 O3 (S13) and R105 O3 (S12) — extended by the same-styles ruling after measuring the tokens each view uses (`evidence/colour-token-scan-2026-09-21.json`); element list and colour tokens from R004 O4/O10 and R001 O4 (axe) |
