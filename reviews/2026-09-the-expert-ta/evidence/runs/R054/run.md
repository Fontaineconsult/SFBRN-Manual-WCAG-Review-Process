...
| LV8 — The view works in both portrait and landscape | pass | O4 — no orientation media query and no screen.orientation.lock use (25 inline + 47 external scripts scanned, 1 unreadable) — content is not restricted to one orientation |
...
**view_probe 2026-09-11:** answered LV1=fail, LV3=pass, LV8=pass by measurement; facts in `R054-probe.json`.
...
- O4 [measured] (state: view as loaded, 2026-09-11 view_probe): no orientation media query and no screen.orientation.lock use (25 inline + 47 external scripts scanned, 1 unreadable) — content is not restricted to one orientation
