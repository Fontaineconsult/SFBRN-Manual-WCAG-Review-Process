...
python scripts/dashboard.py <review> [--open]     # HTML dashboard reviews/<id>/<id>-dashboard.html from the database (regenerated by every sync; --open shows it in the browser)
