...
| **Result** | Not set — NC1, NC3 need the reviewer — judge from `R119-grayscale.png` (achromatopsia emulation) or the OS filter; measured fail on NC2 awaits confirmation |
